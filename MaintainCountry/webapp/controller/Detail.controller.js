...
sap.ui.define([
	...
	return BaseController.extend("saptw.MaintainCountry.controller.Detail", {
		...
		onDelete: function () {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/countryName"),
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("Country", oParameter);
		...
		_onBindingChange: function () {
			...
			var sPath = oElementBinding.getBoundContext().getPath(),
				...
				sObjectId = oObject.countryId,
				sObjectName = oObject.countryName;
