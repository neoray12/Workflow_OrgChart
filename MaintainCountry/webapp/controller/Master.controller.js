/*global history */
sap.ui.define([
	"saptw/MaintainCountry/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"saptw/MaintainCountry/model/formatter",
	"sap/m/MessageBox",
	"saptw/MaintainCountry/model/grouper",
	...
	return BaseController.extend("saptw.MaintainCountry.controller.Master", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("countryName", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("saptw.MaintainCountry.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
				case "Filter1":
					aFilters.push(new Filter("countryId", FilterOperator.LE, 100));
					break;
				case "Filter2":
					aFilters.push(new Filter("countryId", FilterOperator.GT, 100));
					break;
				default:
					break;
				}
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							countryId: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("countryId"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				countryId: encodeURIComponent(oItem.getBindingContext().getProperty("countryId"))
			}, bReplace);
		},
