sap.ui.define([
	...
	return BaseObject.extend("saptw.MaintainCountry.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias saptw.MaintainCountry.model.ListSelector
		 */
		 ...
		 * @return {saptw.MaintainCountry.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
