sap.ui.define([
	...
	opaTest("MasterList Filtering on countryId less than 100", function (Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("countryId").
	...
	opaTest("MasterList Filtering on countryId more than 100", function (Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 currency").
		and.iPressOKInViewSelectionDialog();
