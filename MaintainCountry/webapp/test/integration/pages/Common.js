sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("saptw/MaintainCountry/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#MaintainCountry-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#MaintainCountry-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("saptw.MaintainCountry.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["saptw/MaintainCountry/localService/mockserver"], function (mockserver) {
