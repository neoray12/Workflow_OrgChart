/*global history */
sap.ui.define([
	"saptw/MaintainDepartment/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"saptw/MaintainDepartment/model/formatter",
	"sap/m/MessageBox",
	"saptw/MaintainDepartment/model/grouper",
	...
	return BaseController.extend("saptw.MaintainDepartment.controller.Master", {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("saptw.MaintainDepartment.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
				case "Filter1":
					aFilters.push(new Filter("departmentId", FilterOperator.LE, 100));
					break;
				case "Filter2":
					aFilters.push(new Filter("departmentId", FilterOperator.GT, 100));
					break;
				default:
					break;
				}
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							departmentId: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("departmentId"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				departmentId: encodeURIComponent(oItem.getBindingContext().getProperty("departmentId"))
			}, bReplace);
		},
