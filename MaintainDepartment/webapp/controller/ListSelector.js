sap.ui.define([
	...
	return BaseObject.extend("saptw.MaintainDepartment.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias saptw.MaintainDepartment.model.ListSelector
		 */
		 ...
		 * @return {saptw.MaintainDepartment.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
