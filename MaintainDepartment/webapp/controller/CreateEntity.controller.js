sap.ui.define([
	...
	return BaseController.extend("saptw.MaintainDepartment.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Department", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("Department", oData);
