sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("saptw/MaintainDepartment/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#MaintainDepartment-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#MaintainDepartment-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("saptw.MaintainDepartment.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["saptw/MaintainDepartment/localService/mockserver"], function (mockserver) {
