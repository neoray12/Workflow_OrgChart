sap.ui.define([
	...
	opaTest("MasterList Filtering on departmentId less than 100", function (Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("departmentId").
		and.iSelectListItemInViewSettingsDialog("<100 division").
	...
	opaTest("MasterList Filtering on departmentId more than 100", function (Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 division").
		and.iPressOKInViewSelectionDialog();
