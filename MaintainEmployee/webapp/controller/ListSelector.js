sap.ui.define([
	...
	return BaseObject.extend("saptw.MaintainEmployee.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias saptw.MaintainEmployee.model.ListSelector
		 */
		 ...
		 * @return {saptw.MaintainEmployee.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
