/*global history */
sap.ui.define([
	"saptw/MaintainEmployee/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"saptw/MaintainEmployee/model/formatter",
	"sap/m/MessageBox",
	"saptw/MaintainEmployee/model/grouper",
	...
	return BaseController.extend("saptw.MaintainEmployee.controller.Master", {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("saptw.MaintainEmployee.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
				case "Filter1":
					aFilters.push(new Filter("managerId", FilterOperator.LE, 100));
					break;
				case "Filter2":
					aFilters.push(new Filter("managerId", FilterOperator.GT, 100));
					break;
				default:
					break;
				}
