sap.ui.define([
	...
	return BaseController.extend("saptw.MaintainEmployee.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Employee", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("Employee", oData);
