sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("saptw/MaintainEmployee/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#MaintainEmployee-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#MaintainEmployee-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("saptw.MaintainEmployee.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["saptw/MaintainEmployee/localService/mockserver"], function (mockserver) {
