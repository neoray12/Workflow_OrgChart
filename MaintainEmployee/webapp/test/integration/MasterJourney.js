sap.ui.define([
	...
	opaTest("MasterList Filtering on managerId less than 100", function (Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("managerId").
		and.iSelectListItemInViewSettingsDialog("<100 email").
	...
	opaTest("MasterList Filtering on managerId more than 100", function (Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 email").
		and.iPressOKInViewSelectionDialog();
